<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Vote_V_Chairperson.aspx.cs" Inherits="Vote_V_Chairperson" %>
        ...
        <p>
            <asp:Label ID="Label1" runat="server" Text="V" style="font-family:Lucida Calligraphy; font-size:70px; margin: 0 0 0 394px;"></asp:Label>
                    <asp:Label ID="Label2" runat="server" Text="oting" style="font-family:Lucida Calligraphy; font-size:50px"></asp:Label>
                            ...
                            &nbsp; <asp:Label ID="category1" runat="server"  style="font-family:Lucida Calligraphy; font-size:50px">Vice Chairperson</asp:Label>
                 <br />
