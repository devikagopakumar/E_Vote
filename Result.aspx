...
.w3-button {width:150px;}
    ...
    <table class="nav-justified">
        <tr>
            <td>
                <img class="auto-style2" src="PIC/congrats777.gif" /></td>
        </tr>
    </table>
</head>
    ...
    margin: 0 0 0 130px; padding: 0 11px 0 0;">
           <tr>
               <td>
                      ...
                      <br />
                      <asp:GridView ID="GridView1" style="width:800px; margin: 0 0 0 -86px;" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                          <Columns>
                              <asp:BoundField DataField="category" HeaderText="Category" />
                              <asp:BoundField DataField="election_id" HeaderText="Elecrion-ID" />
                              <asp:ImageField DataImageUrlField="image" HeaderText="Image">
                                  <ControlStyle Height="70px" Width="90px" />
                              </asp:ImageField>
                              <asp:BoundField DataField="vote_count" HeaderText="Vote Count" />
                              <asp:CommandField HeaderText="About Me" SelectText="Click Here" ShowSelectButton="True" />
                          </Columns>
