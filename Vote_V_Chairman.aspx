<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Vote_V_Chairman.aspx.cs" Inherits="Vote_V_Chairman" %>
        ...
        <p>
            <asp:Label ID="Label1" runat="server" Text="V" style="font-family:Lucida Calligraphy; font-size:70px; margin: 0 0 0 394px;"></asp:Label>
                    <asp:Label ID="Label2" runat="server" Text="oting" style="font-family:Lucida Calligraphy; font-size:50px"></asp:Label>
                            ...
                            &nbsp; <asp:Label ID="category1" runat="server"  style="font-family:Lucida Calligraphy; font-size:50px">Vice Chairman</asp:Label>
                 <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    margin: 0 0 0 141px;">
        ...
        <p>
            <asp:Button ID="Back" runat="server" BackColor="#9999FF" CssClass="auto-style2" Font-Bold="True" Font-Size="Large" ForeColor="White" OnClick="Back_Click" Text="BACK" />
        </p>
        <p>
        </p>
        <p>
