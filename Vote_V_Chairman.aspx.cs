...
public partial class Vote_V_Chairman : System.Web.UI.Page
{
    Student db;
    SqlConnection con;
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        /* string s = "insert into Voting_Details (s_id,count,category,election_id,election_label,date_time) values ('" + sid.Text + "','" + count + "','" + category + "','" + eid + "','" + label + "','" + date_and_time.Text + "')";
         db.insert(s);*/
        string s12 = "update Vote_Entry set vice_chairman = '" + 1 + "' where s_id='" + sid.Text + "'";
        db.update(s12);
