<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" CodeFile="Student_Details_Edition.aspx.cs" Inherits="Student_Details_Edition" %>
     ...
     <table class="auto-style1" style="border:1px solid black; width: 820px; margin: 0 0 0 252px; padding: 0 11px 0 0;">
           ...
           <tr>
               ...
               <td class="auto-style16">
                   <asp:Image ID="Image1" runat="server" Height="80px" Width="108px" />
               </td>
           </tr>
           <tr>
...
&nbsp;
                   <asp:Button ID="Click_Here" runat="server" Text="CLICK HERE" Style=" color:white; border:0px;" Font-Bold="True" OnClick="Click_Here_Click" BackColor="Red" />
                   </td>
           </tr>
           <tr>
